...
/*       1   2   3   4   5   6   7   8        represents [IP˘1/P]   */
...
/*****************************************************************/
CRYPTO_API int des(unsigned char *keyin, unsigned char *input, int length,   /* DES - */
...
* -> brg
*****************************************************************/
CRYPTO_API int triple_des(unsigned char *keyin, unsigned char *input, int length,      /* Triple-DES - */
               unsigned char *output, char par1, char par2, char par3)      /* Funktion     */
{
 int  i, j = 0, isoflag = 0;
