========================================================================
    MICROSOFT 基础类库 : BasicConvert 项目概述
========================================================================


应用程序向导已为您创建了此 BasicConvert DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 BasicConvert DLL 的每个文件的内容。

BasicConvert.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、配置和项目功能的信息。

BasicConvert.vcxproj.filters
...
BasicConvert.h
    这是 DLL 的主头文件。  它声明了 CBasicConvertApp 类。

BasicConvert.cpp
    这是主 DLL 源文件。  它包含 CBasicConvertApp 类。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 BasicConvert.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
